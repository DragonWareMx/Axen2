...
@section('header')
    ...
    style="margin-top:140px !important">
        ...
        <div class="uk-width-1-1 uk-padding-large uk-padding-small-bottom uk-background-primary uk-padding-remove-top uk-flex uk-flex-wrap uk-margin-medium-bottom container-info-product">
    ...
    <img src={{asset('/img/nosotros/onda.png')}} class="img-onda-abajo" uk-scrollspy="cls: uk-animation-slide-bottom; repeat: false">
