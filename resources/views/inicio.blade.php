...
@section('header')
{{-- parte blanca --}}
<div class='ini_background'
    style='background:no-repeat center url("/img/back/inicio1.jpg");background-size:cover;padding-top:100px;'>
    <div class='ini_content'>
        <div style='color:#250d4b;font-size:80px;font-weight:bold;line-height:1;' class='uk-width-1-1'>Que tu dinero
        </div>
        <div style='color:#250d4b;font-size:40px;font-weight:bold;margin-top:0px;' class='uk-width-1-1'>Trabaje mientras
            descansas</div>
